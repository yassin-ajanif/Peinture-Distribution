...
namespace GestionCommerciale.Shared.Database.Migrations
{
    ...
    [Migration("20260915145300_AddDocumentTiersForeignKeys")]
    partial class AddDocumentTiersForeignKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Personnel.Models.BonCharge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("DepotLocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(1);
                    ...
                    b.HasIndex("DepotLocationId");

                    b.HasIndex("Numero")
                        .IsUnique();

                    b.ToTable("BonsCharge", (string)null);
                });

            modelBuilder.Entity("GestionCommerciale.Modules.Personnel.Models.BonChargeLigne", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("BonChargeId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("BonChargeId");

                    b.HasIndex("ProduitId");

                    b.ToTable("BonChargeLignes", (string)null);
                });

            modelBuilder.Entity("GestionCommerciale.Modules.Personnel.Models.BonDecharge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("BonsDecharge", (string)null);
                });

            modelBuilder.Entity("GestionCommerciale.Modules.Personnel.Models.BonDechargeLigne", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("BonDechargeId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("BonDechargeId");

                    b.HasIndex("ProduitId");

                    b.ToTable("BonDechargeLignes", (string)null);
                });

            modelBuilder.Entity("GestionCommerciale.Modules.Preparation.Models.BonPreparation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Preparation.Models.BonPreparationLigne", b =>
                {
                    ...
                    b.ToTable("BonPreparationLignes");
                });

            modelBuilder.Entity("GestionCommerciale.Modules.Preparation.Models.PaiementBonPreparation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("PaiementsBonPreparation");
                });
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Stock.Models.MouvementStock", b =>
                {
                    ...
                    b.HasIndex("OrigineType", "OrigineId");
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Stock.Models.StockLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("StockLocations", null, t =>
                        {
                            t.HasCheckConstraint("CK_StockLocation_VirtualUser", "(IsVirtual = 0 AND UserId IS NULL) OR (IsVirtual = 1 AND UserId IS NOT NULL)");
                        });
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Personnel.Models.BonCharge", b =>
                {
                    b.HasOne("GestionCommerciale.Modules.Auth.Models.User", "AssignedToUser")
                        .WithMany()
                        .HasForeignKey("AssignedToUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GestionCommerciale.Modules.Stock.Models.StockLocation", "DepotLocation")
                        .WithMany()
                        .HasForeignKey("DepotLocationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Personnel.Models.BonChargeLigne", b =>
                {
                    b.HasOne("GestionCommerciale.Modules.Personnel.Models.BonCharge", "BonCharge")
                        .WithMany("Lignes")
                        .HasForeignKey("BonChargeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GestionCommerciale.Modules.Stock.Models.Produit", null)
                        .WithMany()
                        .HasForeignKey("ProduitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("BonCharge");
                });
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Personnel.Models.BonDechargeLigne", b =>
                {
                    b.HasOne("GestionCommerciale.Modules.Personnel.Models.BonDecharge", "BonDecharge")
                        .WithMany("Lignes")
                        .HasForeignKey("BonDechargeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Preparation.Models.BonPreparation", b =>
                {
                    ...
                    b.HasOne("GestionCommerciale.Modules.Stock.Models.StockLocation", "StockLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Stock.Models.MouvementStock", b =>
                {
                    b.HasOne("GestionCommerciale.Modules.Stock.Models.StockLocation", "FromLocation")
                        .WithMany()
                    ...
                    b.HasOne("GestionCommerciale.Modules.Stock.Models.StockLocation", "ToLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Stock.Models.StockLocation", b =>
                {
                    b.HasOne("GestionCommerciale.Modules.Auth.Models.User", "User")
                        .WithOne("VirtualStock")
                        .HasForeignKey("GestionCommerciale.Modules.Stock.Models.StockLocation", "UserId")
                        .OnDelete(DeleteBehavior.Restrict);
